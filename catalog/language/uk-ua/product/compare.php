...
$_['text_success']      = 'Успіх: Ви додали <a href="%s">%s</a> до <a href="%s">порівняння товарів</a>!';
$_['text_remove']       = 'Успіх: Порівняння товарів змінено!';
$_['text_no_results']   = 'Ви не обрали жодного товару для порівняння.';
